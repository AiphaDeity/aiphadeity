...
export const site = {
  ...
  url: "https://aiphadeity.cn",
  avatar: "https://aiphadeity.cn/favicon/avatar-128.png",
  email: "mr.zhang2002@qq.com",
};
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">申请模板，把内容复制修改后发送邮件即可</p>
